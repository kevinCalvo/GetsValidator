        ...
        >
            ...
            <div className="py-10">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 sm:w-full flex sm:flex-col md:flex-row  gap-4">
                    <div className="bg-white  overflow-hidden sm:w-full md:w-1/2 shadow-sm sm:rounded-lg">
                        <h1 className=" bg-[#C39BD3] p-4 text-xl font-bold ">Resumen del Plan</h1>
                        <ul className='p-4'>
                    ...
                    <div className="bg-white  overflow-hidden sm:w-full md:w-1/2  sm:rounded-lg">

                        <h1 className="bg-[#C39BD3]  text-xl font-bold p-4 ">Total de Usuarios registrados</h1>
